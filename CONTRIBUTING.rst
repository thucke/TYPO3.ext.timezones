...
* If you find something missing or something is wrong in this manual,
  you are welcome to write an `issue <https://github.com/thucke/TYPO3.ext.timezones/issues/new>`__
...
* In order to make changes on a
  `rendered page <https://docs.typo3.org/p/thucke/timezones/master/en-us/>`__,
