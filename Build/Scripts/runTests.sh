...
if [[ -n "${1}" ]]; then
    ...
    case ${TEST_SUITE} in
        acceptance)
            TEST_FILE="Web/typo3conf/ext/timezones/Tests/Acceptance"
            ;;
        functional)
            TEST_FILE="Web/typo3conf/ext/timezones/Tests/Functional"
            ;;
        unit)
            TEST_FILE="Web/typo3conf/ext/timezones/Tests/Unit"
            ;;
    esac
fi
